...
const mockUtilaje = [
  { id: 1, marca: "John Deere", model: "6130R", putere_cp: 130, judet: "Cluj", pret_zi: 450, disponibil: true },
  { id: 2, marca: "Fendt", model: "724 Vario", putere_cp: 240, judet: "Timiș", pret_zi: 780, disponibil: true },
  { id: 3, marca: "Case IH", model: "Optum 270", putere_cp: 270, judet: "Brașov", pret_zi: 620, disponibil: true },
  { id: 4, marca: "New Holland", model: "T7.315", putere_cp: 315, judet: "Iași", pret_zi: 530, disponibil: true },
  { id: 5, marca: "Claas", model: "Axion 870", putere_cp: 295, judet: "Sibiu", pret_zi: 710, disponibil: false },
  { id: 6, marca: "Deutz-Fahr", model: "9340 TTV", putere_cp: 340, judet: "Mureș", pret_zi: 850, disponibil: true },
];

const judete = ["Toate", "Cluj", "Timiș", "Brașov", "Iași", "Sibiu", "Mureș"];
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    else setUser({ nume: "Fermier", prenume: "" });
  ...
  const utilajeFiltrate = mockUtilaje.filter(u => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        }}>Platforma #1 de închirieri agricole din România</p>
      ...
      <div style={{
        ...
        {[
          { val: "1,240+", label: "Utilaje disponibile" },
      ...
      <footer style={{
        ...
        <p style={{ margin: 0, opacity: 0.6 }}>© 2025 TraktorBNB · Platforma fermierilor români</p>
      </footer>
    </div>
  );
}