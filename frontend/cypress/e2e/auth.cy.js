describe('Validare formulare Auth', () => {
  ...
  describe('Signup', () => {
    ...
    it('afiseaza eroare pentru parole diferite', () => {
      cy.get('input[placeholder="Ex: Popescu"]').type('Ion')
      cy.get('input[placeholder="Ex: Ion"]').type('Pop')
      cy.get('input[type="email"]').type('ion@test.com')
      cy.get('input[type="tel"]').type('0712345678')
      cy.get('input[placeholder="Minim 6 caractere"]').type('parola123')
      cy.get('input[placeholder="Confirmă parola"]').type('altaparola')
    ...
    it('afiseaza eroare pentru parola prea scurta', () => {
      ...
      cy.get('input[type="email"]').type('ion@test.com')
      cy.get('input[type="tel"]').type('0712345678')
      cy.get('input[placeholder="Minim 6 caractere"]').type('123')
      cy.get('input[placeholder="Confirmă parola"]').type('123')
      cy.get('button').contains('Creează Cont').click()
    ...
    it('afiseaza eroare pentru telefon invalid', () => {
      ...
      cy.get('input[placeholder="Minim 6 caractere"]').type('parola123')
      cy.get('input[placeholder="Confirmă parola"]').type('parola123')
      cy.get('button').contains('Creează Cont').click()
